...
import '../../Css/Business/BusinessHelped.css'
...
const BusinessHelped = () => {
   const { t, i18n } = useTranslation();
   return (
      <div className="contanier">
      <div className='business-helped'>
         <div className="business-helped-main">
            <div className="business-helped-main-first">
               <h1> {t("B-Nine-ln1")} </h1>
               <h1> &nbsp; &nbsp;{t("B-Nine-ln2")}</h1> </div>
            <div className="business-helped-main-cardgroup">
               <div className="business-helped-main-card"><div className="img"> <img src={ninesec1p} alt="" />
               </div>
                  <span>{t("B-Nine-ln3")}</span>
                  <h3>{t("B-Nine-ln4")}</h3>
                  <p>{t("B-Nine-ln5")}</p>             
               </div>
               <div className="business-helped-main-card"><div className="img"><img src={ninesec2p} alt="" /> </div>
                  <span>{t("B-Nine-ln6")}</span>
                  <h3>{t("B-Nine-ln7")}</h3>
                  <p>{t("B-Nine-ln8")}</p>
               </div>
               <div className="business-helped-main-card"><div className="img"><img src={ninesec3p} alt="" /></div>
                  <span>{t("B-Nine-ln9")}</span>
                  <h3>{t("B-Nine-ln10")}</h3>
                  <p>{t("B-Nine-ln11")}</p>
               </div>
               <div className="business-helped-main-card"><div className="img"><img src={ninesec4p} alt="" /></div>
